                     ...
                     @foreach ($carts as $cart)
                        <tr>
                            ...
                            <td style="width: 35%">
                                ...
                                <div class="product-substitle">By {{ $cart->product->user->store_name }}</div>
                            </td>
                            <td style="width: 35%">
                            ...
                            <td style="width: 20%">
                                <form action="{{ route('cart-delete', $cart->id) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="btn btn-danger btn-remove-cart">Remove</button>
                                </form>
                            </td>
                        </tr>
                        @php
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <option value="regencies_id">Kudus</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
